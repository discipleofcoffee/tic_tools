...
if __name__ == "__main__":
     ...
     parser.add_argument("--run_stage",     help="Stages to run in the processing pipeline", type=int, nargs='*', default = [ 1,2,3 ],
                         choices = [ 1,2,3 ] )
