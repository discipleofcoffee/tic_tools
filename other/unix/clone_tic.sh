...
if [ ! -d $TIC_SETUP_PATH ]; then
    ...
    cp $TIC_REPOSITORY_PATH/tic_labels/other/unix/tic_labels.sh $TIC_SETUP_PATH
    cp $TIC_REPOSITORY_PATH/tic_outliers/other/unix/tic_outliers.sh $TIC_SETUP_PATH
    cp $TIC_REPOSITORY_PATH/tic_protocol_check/other/unix/tic_protocol_check.sh $TIC_SETUP_PATH
    cp $TIC_REPOSITORY_PATH/tic_redcap_link/other/unix/tic_redcap_link.sh $TIC_SETUP_PATH
fi